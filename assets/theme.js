...
$(document).ready(function(){
  ...
  $('.header-search-icon').click(function(){
   $('.header-serch-form').show(); 
    
  });
});

$(".hide-search").click(function(){
    $(".header-serch-form ").hide();
});
...
$(document).ready(function(){
  ...
  $("#SiteNav li").click(function(){
    ...
    $("#SiteNav li .site-nav__dropdown").slideUp();
 ...
 jQuery.ajax({
        ...
        success: function(data) { 
            ...
            if ( item_count > 0 ) {
                ...
                // mini cart data
                jQuery('.mini-cart').attr('id','mini-cart');
                jQuery('.mini-cart-subtotal .sub_price').text( '$' + total_price.toFixed(2) );
                ...
                for( var i = 0; i < item_count; i++ ){
                    if ( data['items'][i]['id'] != null ) {
                     ...
                     cart_list.push('<div class="row mini-cart-product"><div class="col span_3 mini-image"><div class="product_image"><img src="' + image_url + '"  alt="'+ product_title + '" /></div></div><div class="title-value"><div class="col span_6">' + product_url + selected_options + '</div><div class="col span_3">$'+ '<span>' + line_price.toFixed(2) + '</span>' + 'x' + '<strong>' + quantity + '</strong>' + '<input type="hidden" id="updates_' + item_id + '" value="' + quantity + '" /></div> <a href="/cart/change?line='+itm+'&quantity=0" class="cart__remove">X</a></div></div>');  jQuery('.mini-cart-items').html( cart_list.join('') );
...
$('.my-check').removeClass('active');
  $('.my-check').siblings('a').removeClass('active');
  $(this).addClass('active');
   $(this).siblings('a').addClass('active');
   var loct=$('.bg-filter a.active').attr('href');
  location.href = loct;
});
...
$('.content_sidebar ul li a').each(function(){
...
$(document).ready(function() {
   ...
   $("#pro_type").change(function () {
     ...
     var optionValue = $(this).attr("value");
       if ($(this).val() == 22) {
         $('.Salon').show();
         $('#licensing_state').hide();
         $('#CustomerFormlicense_num').hide();
         $('#salon_name').hide();
         $('#AddressCompany_').hide();
         $('#AddressAddress1_').hide();
         $('.salon-name-for').show();
         $('.your-business-name-for').hide();
         $('.school-name-for').hide();
         $('#CustomerFormca_resale_num').show();
         $('.sales-use-optional').hide();
       }
       else if($(this).val() == 23 ){
         
       $('.Salon').hide();
         $('.custoer').hide();
         $('#licensing_state').show();
         $('#CustomerFormlicense_num').show();
         $('.your-business-name-for').show();
         $('.school-name-for').hide();
         $('.sales-use-optional').show();
         $('#CustomerFormca_resale_num').hide();
        $('.salon-name-for').hide();
         
       }
       else if($(this).val() == 79 || $(this).val() == 77){
         ...
         $('.Salon').show();
         $('.your-business-name-for').hide();
         $('.school-name-for').show();

         $('.salon-name-for').hide();
         $('.sales-use-optional').hide();
         $('.custoer').hide();
       }
       else if($(this).val() == 24 || $(this).val() == 25 || $(this).val() == 78){
       $('.your-business-name-for').show();
       $('.school-name-for').hide();
       $('.sales-use-optional').show();
...
$(document).ready(function() {
$('.category-nav .filtr ul li').each(function(){
  $(this).click(function(){
    if($(this).hasClass('selected')){
       var coll= $('.coll-hand').html();
   location.href ="/collections/"+coll;
    }else{
    $('.category-nav .filtr ul li').removeClass('active');
    $(this).addClass('active');
    var coll= $('.coll-hand').html();
    var sub = $(this).siblings('h3').html();
    sub= sub.toLowerCase();
    sub= sub.split(" ").join("-");
    ...
    location.href ="/collections/"+coll+"/"+tag;
    }
...
$(document).ready(function() {
$('.search-header__input').keypress(function(event){
  setTimeout(function(){ 
  var a =$('.search-header__input').val();
  $('.pro-show').html("");
  $('.product-list .list-products li').each(function(){ 
  var protitle = $(this).find('.pro-title-search').html();
    protitle = protitle.toLowerCase();
  var n = protitle.indexOf(a);
    if(n>0){ 
      $(this).addClass(a);      
   var pro =$(this).html();
        
     var bb= $('#pro-show-struct .pro-list-instant').length;
      if(bb<4){
    $('#pro-show-struct').append(pro);
      }
    }
  ...
  $('.collection-list-instant .list-instant .coll-instant-str .coll-instant-str-list').each(function(){  
  var colltitle = $(this).find('.coll-title-instant').html();
    colltitle = colltitle.toLowerCase();
  var coll = colltitle.indexOf(a);
    if(coll>0){ 
      $(this).addClass(coll);
   var procoll =$(this).html();
    $('#coll-instant').append(procoll);
    }
...
//      var as =$('.search-header__input').val();
//      $('.product-list .list-products li').each(function(){
//        var protitle = $(this).find('.pro-title-search').html();       
//        protitle = protitle.toLowerCase();
//         var n = protitle.split(" "); 
//        var arr =[];
//        arr.push(n);
//        console.log(arr);
//        if(jQuery.inArray(as, arr) !== -1){
//        console.log(as);
//        }
// //     if(n>0){ 
...
$('.open-catenav').click(function(){
    $(".left_sidebar").addClass("slide_open");
});

$('.category-nav-header').click(function(){
    $(".left_sidebar").removeClass("slide_open");
});
...
$('#play-button').click(function(){
 ...
 player.api('play');
    ...
    $(".be_first").click(function() {
      $("#shopify-product-reviews").find(".spr-summary-actions-newreview").trigger("click");
      $('.review_popup').addClass('show_review');
      $('body').addClass('review_scroll');
  	});

	$(".be_review").click(function() {
      $("#shopify-product-reviews").find(".spr-summary-actions-newreview").trigger("click");
      $('.review_popup').addClass('show_review');
      $('body').addClass('review_scroll');
  	});	

	$(".actions-newreview").click(function() {
      $("#shopify-product-reviews").find(".spr-summary-actions-newreview").trigger("click");
      $('.review_popup').addClass('show_review');
      $('body').addClass('review_scroll');
  	});	
	
	$(".review_close").children('span').click(function() {
      $("#shopify-product-reviews").find(".spr-summary-actions-newreview").trigger("click");
      $('.review_popup').removeClass('show_review');
      $('body').removeClass('review_scroll');
    });  
