...
!(function (e) {
    "use strict";
    function t(t, i, r, s) {
        e.ajax({ url: t, dataType: "jsonp", contentType: "application/json", data: i, success: r, error: s });
    }
    function i(e) {
    ...
    function s(e, t = {}) {
        ...
        return (
            i && ((this.inputId = parseInt(i[1])), (this.message = i[2])),
            (this.code = Object.keys(this.mapping).find((e) => this.mapping[e].test(this.message)) || "UNCAUGHT"),
            "UNCAUGHT" === this.code && (console.warn("If you see this message, please open an issue (https://github.com/ddimitrioglo/jquery-mailchimp/issues) with details below"), console.warn(e)),
            { input: this.inputId, message: t[this.code] ? t[this.code] : this.message, isError: this.isError }
        );
    }
    e.fn.MCForm = function (n) {
        return this.each(function () {
            ...
            p.map((e, t) => {
                ...
                l[t] = { name: e, $inputEl: i.find(c.inputSelector), $errorEl: i.find(c.errorSelector) };
            }),
                m.on("click", function (e) {
                    i(e),
                        o(),
                        t(
                            c.url.replace("/post?", "/post-json?").concat("&c=?"),
                            a(),
                            function (e) {
